...
export const PROJECT_RECIPES = [
  {
    key: 'review', icon: 'Search', label: 'Brutal review', group: 'Kvalitet',
  ...
  {
    key: 'ui', icon: 'Sparkles', label: 'UI/UX-løft', group: 'Kvalitet',
  ...
  {
    key: 'bughunt', icon: 'Bug', label: 'Bug-jakt', group: 'Kvalitet',
  ...
  {
    key: 'cleanup', icon: 'Brush', label: 'Rydd koden', group: 'Kvalitet',
  ...
  {
    key: 'schema', icon: 'Database', label: 'Datamodell', group: 'Arkitektur',
  ...
  {
    key: 'refactor', icon: 'Recycle', label: 'Refaktor-plan', group: 'Arkitektur',
  ...
  {
    key: 'launch', icon: 'Rocket', label: 'Launch-sjekk', group: 'Lansering',
  ...
  {
    key: 'landing', icon: 'Megaphone', label: 'Landingstekst', group: 'Lansering',
  ...
  {
    key: 'growth', icon: 'TrendingUp', label: 'Vekst-ideer', group: 'Lansering',
