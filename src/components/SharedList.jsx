...
export default function SharedList() {
  const items = useLiveQuery(() => listSharedItems(), [], [])
    ...
    <div className="screen">
      <div className="screen-scroll">
        <div className="scr-top">
          <div>
            <h1 className="scr-title">Delt liste</h1>
            <p className="scr-sub">
        ...
        {showInvite && (
          <div className="share-panel card">
            ...
            <p className="share-hint">
              ...
              hun logger inn. Bare denne lista deles — alt annet er privat.
            </p>
          </div>
        )}
        ...
        <div style={{ marginTop: 20 }}>
          {items.length === 0 ? (
            <div className="empty">
              ...
              <p className="em-ttl">Ingenting delt enda</p>
              <p>Legg til noe nederst — handleliste, ting å huske sammen — og trykk «Del» for å invitere.</p>
            </div>
          ) : (
            <>
